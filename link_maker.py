...
url = f"https://www.linkedin.com/jobs/search/?currentJobId=2557487241&keywords=data%20scientist&position=1&pageNum=0"
...
df.to_csv("job_idszzz.csv", encoding='utf-8', index=False,header=False,mode='a')
